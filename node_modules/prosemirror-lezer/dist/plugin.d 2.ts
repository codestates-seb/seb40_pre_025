...
import { ParserCollection } from "./getHighlightDecorations";
/**
 ...
 * @internal
 */
export declare class TreeFragmentCache {
    private cache;
    constructor(cache: {
        [pos: number]: {
     ...
     */
    set(pos: number, node: ProseMirrorNode, fragments: readonly TreeFragment[]): void;
    /**
     ...
     */
    replace(oldPos: number, newPos: number, node: ProseMirrorNode, fragments: readonly TreeFragment[]): void;
    /**
 ...
 * @public
 */
export declare function highlightPlugin(parsers: ParserCollection, nodeTypes?: string[], languageExtractor?: (node: ProseMirrorNode) => string, highlighter?: Highlighter): Plugin<HighlightPluginState>;
