...
const defaultMarkdownSerializerNodes = Object.assign(Object.assign({}, defaultMarkdownSerializer.nodes), { blockquote(state, node) {
...
function genMarkupAwareMarkConfig(config) {
    ...
    return Object.assign(Object.assign({}, config), { open(_, mark) {
...
const customMarkdownSerializerMarks = Object.assign(Object.assign({}, defaultMarkdownSerializer.marks), { em: genMarkupAwareMarkConfig(defaultMarkdownSerializer.marks.em), strong: genMarkupAwareMarkConfig(defaultMarkdownSerializer.marks.strong), code: extendedCodeMarkDeserializer, link: extendedLinkMarkDeserializer, strike: genMarkupAwareMarkConfig({
        open: "~~",
        close: "~~",
        mixable: true,
...
export const stackOverflowMarkdownSerializer = (externalPluginProvider) => new SOMarkdownSerializer(Object.assign(Object.assign(Object.assign({}, defaultMarkdownSerializerNodes), customMarkdownSerializerNodes), externalPluginProvider.markdownProps.serializers.nodes), Object.assign(Object.assign({}, customMarkdownSerializerMarks), externalPluginProvider.markdownProps.serializers.marks));
