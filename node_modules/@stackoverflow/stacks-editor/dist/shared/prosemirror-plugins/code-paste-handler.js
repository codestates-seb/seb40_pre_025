...
function getDetectedCode(clipboardData, htmlDoc) {
    ...
    const codeEl = htmlDoc === null || htmlDoc === void 0 ? void 0 : htmlDoc.querySelector("code");
    if (htmlDoc && codeEl) {
...
export function parseCodeFromPasteData(clipboardData, doc) {
    ...
    if (doc &&
        ...
        htmlContent !== null && htmlContent !== void 0 ? htmlContent : (htmlContent = getHtmlClipboardContent(clipboardData));
