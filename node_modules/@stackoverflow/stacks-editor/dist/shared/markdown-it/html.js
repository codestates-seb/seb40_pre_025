...
function getTagInfo(tag) {
    ...
    if (supportedAttrs === null || supportedAttrs === void 0 ? void 0 : supportedAttrs.length) {
        for (const attr of supportedAttrs) {
            attributes[attr] =
                ((_a = new RegExp(`${attr}=["'](.+?)["']`).exec(tag)) === null || _a === void 0 ? void 0 : _a[1]) || "";
        }
    }
    return {
        type: tagType,
...
function sanitizeHtmlString(content) {
    var _a;
    const tags = (_a = content.match(/(<\/?[a-z]+.*?>)/gi)) === null || _a === void 0 ? void 0 : _a.map((t) => ({
        match: t,
...
function mergeSplitBlockHtmlTokens(tokens) {
    ...
    let blockIndexes = tokens
        ...
        const openTags = (_b = (_a = t.content.match(/<[a-z]+(\s[a-z0-9\-"'=\s])?>/gi)) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0;
        const closeTags = (_d = (_c = t.content.match(/<\/[a-z]+>/gi)) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0;
        // TODO accurate?
