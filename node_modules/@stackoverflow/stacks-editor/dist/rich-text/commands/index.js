...
export function toggleHeadingLevel(attrs) {
    return (state, dispatch) => {
        ...
        if (nodeCheck(state) &&
            (headingLevel === 6 || headingLevel === (attrs === null || attrs === void 0 ? void 0 : attrs.level))) {
            return setBlockType(state.schema.nodes.paragraph)(state, dispatch);
        }
        const updatedAttrs = !(attrs === null || attrs === void 0 ? void 0 : attrs.level)
            ? Object.assign(Object.assign({}, attrs), { level: headingLevel + 1 }) : attrs;
...
export function toggleTagLinkCommand(options, isMetaTag) {
    return (state, dispatch) => {
        ...
        if (nodeCheck(state)) {
            ...
            const selectedText = (_a = state.selection.content().content.firstChild) === null || _a === void 0 ? void 0 : _a.textContent;
...
export function insertRichTextLinkCommand(state, dispatch, view) {
    ...
    if (dispatch && valid) {
        ...
        if (state.selection.empty && $anchor.textOffset) {
            ...
            selectedText =
                (_b = (_a = state.selection.content().content.firstChild) === null || _a === void 0 ? void 0 : _a.textContent) !== null && _b !== void 0 ? _b : null;
            const linkMatch = /^http(s)?:\/\/\S+$/.exec(selectedText);
            linkUrl = (linkMatch === null || linkMatch === void 0 ? void 0 : linkMatch.length) > 0 ? linkMatch[0] : "";
        }
...
export function exitInclusiveMarkCommand(state, dispatch) {
    ...
    if (!(exitables === null || exitables === void 0 ? void 0 : exitables.length)) {
        return false;
    }
    ...
    let endExitables;
    let tr = state.tr;
    if (nextNode && ((_a = nextNode.marks) === null || _a === void 0 ? void 0 : _a.length)) {
