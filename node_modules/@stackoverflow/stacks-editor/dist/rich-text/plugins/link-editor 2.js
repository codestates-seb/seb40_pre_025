...
export class LinkEditor extends PluginInterfaceView {
    ...
    update(view) {
        ...
        if (this.isShown) {
            ...
            if (state === null || state === void 0 ? void 0 : state.url) {
                this.hrefInput.value = state.url;
                this.validate(state.url);
            }
            if (state === null || state === void 0 ? void 0 : state.text) {
...
class LinkTooltip {
        ...
        this.content.innerHTML = escapeHTML `<div class="s-popover is-visible p4 w-auto wmx-initial wmn-initial js-link-tooltip"
            ...
            <div class="d-flex ai-center">
                ...
                <button type="button"
                        ...
                        title="${_t("link_tooltip.edit_button_title")}"><span class="svg-icon icon-bg iconPencilSm"></span></button>
                <button type="button"
                        class="flex--item s-btn js-link-tooltip-remove"
                        title="${_t("link_tooltip.remove_button_title")}"><span class="svg-icon icon-bg iconTrashSm"></span></button>
            </div>
        </div>`;
    ...
    getDecorations(value, newState) {
        ...
        const decoration = Decoration.widget(newState.selection.from, (view) => {
...
export const linkEditorPlugin = (features) => new StatefulPlugin({
    ...
    state: {
        ...
        apply(tr, value, _, newState) {
            ...
            return Object.assign(Object.assign({}, meta), { forceHideTooltip: value.forceHideTooltip && tooltipIsShowing(decorations), linkTooltip: value.linkTooltip, decorations: decorations });
        },
    },
    props: {
        decorations(state) {
