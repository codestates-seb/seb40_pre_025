  ...
  return (
    <div className="section">
        ...
        <div className="content center">
          <h1 id="master">
            ...
            <div id="master-container-scroller">
              ...
              <div className="master-container-scroller_item">김효준</div>
              <div className="master-container-scroller_item">허준오</div>
              <div className="master-container-scroller_item">김민성</div>
              <div className="master-container-scroller_item">안지수</div>
              <div className="master-container-scroller_item">윤세연</div>
      ...
      <style jsx>{`
        ...
        #master-container {
          -webkit-animation: master-container-bg 15s
            cubic-bezier(0.645, 0.045, 0.355, 1) infinite;
          animation: master-container-bg 15s
            cubic-bezier(0.645, 0.045, 0.355, 1) infinite;
          display: -webkit-flex;
          display: -ms-flexbox;
          display: flex;
        ...
        @media screen and (max-width: 615px) {
          #master-container {
            -webkit-animation: master-container-bg-mobile 15s
              cubic-bezier(0.645, 0.045, 0.355, 1) infinite;
            animation: master-container-bg-mobile 15s
              cubic-bezier(0.645, 0.045, 0.355, 1) infinite;
          }
        }
        @media screen and (max-width: 615px) {
        ...
        #master-container-scroller .master-container-scroller_item {
          display: block;
          padding-bottom: 6px;
          -webkit-animation: scroll 15s cubic-bezier(0.645, 0.045, 0.355, 1)
            infinite;
        ...
        #master-container-scroller
          .master-container-scroller_item:nth-child(1)
          a {
          color: #e65f48;
        }
        #master-container-scroller .master-container-scroller_item:nth-child(2),
        #master-container-scroller
          .master-container-scroller_item:nth-child(2)
          a {
          color: #e99485;
        }
        ...
        #master-container-scroller
          .master-container-scroller_item:nth-child(3)
          a {
          color: #76bcad;
        }
        ...
        #master-container-scroller
          .master-container-scroller_item:nth-child(4)
          a {
          color: #84719f;
        }
        ...
        #master-container-scroller
          .master-container-scroller_item:nth-child(5)
          a {
          color: #d47787;
        }
        ...
        #master-container-scroller
          .master-container-scroller_item:nth-child(6)
          a {
          color: #f09551;
        }
        ...
        #master-container-scroller
          .master-container-scroller_item:nth-child(7)
          a {
          color: #349ab5;
        }
        #master-container-scroller .master-container-scroller_item:nth-child(8),
        #master-container-scroller
          .master-container-scroller_item:nth-child(8)
          a {
          color: #e65f48;
        }
