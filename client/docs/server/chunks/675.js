...
exports.ids = [675];
exports.modules = {
  /***/ 8566: /***/ (module, exports, __webpack_require__) => {
    "client";
    "use strict";
    ...
    function Image(_param) {
      ...
      if (layout === "fill") {
        ...
        // <img src="i.png" width="100" height="100" />
        const quotient = heightInt / widthInt;
        const paddingTop = isNaN(quotient) ? "100%" : `${quotient * 100}%`;

        if (layout === "responsive") {
          // <img src="i.png" width="100" height="100" layout="responsive" />
          wrapperStyle.display = "block";
          wrapperStyle.position = "relative";
          hasSizer = true;
          sizerStyle.paddingTop = paddingTop;
        } else if (layout === "intrinsic") {
          // <img src="i.png" width="100" height="100" layout="intrinsic" />
          ...
          // <img src="i.png" width="100" height="100" layout="fixed" />
          wrapperStyle.display = "inline-block";
          wrapperStyle.position = "relative";
